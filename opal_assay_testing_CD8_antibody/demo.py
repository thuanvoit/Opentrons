...
class Opentron_Chacha:
    ...
    def check_antibodies(self):
        ...
        for antibody in self.antibody_solution:
            if antibody != "empty":
                self.pipette.move_to(self.tuberack[self.antibody_solution[antibody]['position']].top(20))
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    antibody_solution = {
        # --- 1ST ROW ---
        'opal_antibody_dilluent': {'position': 'A1', 'volume': 300, 'time': {"mins": 0, "sec": 10}},
        'cd8_antibody': {'position': 'A2', 'volume': 300, 'time': {"mins": 0, "sec": 30}},
        'tbst': {'position': 'A3', 'volume': 300, 'time': {"mins": 0, "sec": 30}},
        'opal_polymer_HRP': {'position': 'A4', 'volume': 300, 'time': {"mins": 0, "sec": 10}},
        'opal_fluorophore': {'position': 'A5', 'volume': 300, 'time': {"mins": 0, "sec": 10}},
